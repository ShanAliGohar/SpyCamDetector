...
import com.example.spycamdetector.databinding.ActivityHiddenCameraBinding
import com.example.spycamdetector.sharedPref.SaveData
import java.text.DecimalFormat
import java.text.DecimalFormatSymbols
import java.util.Locale

class HiddenCamera : AppCompatActivity(), SensorEventListener{
    var saveData : SaveData? = null
    var mpmetal: MediaPlayer? = null
    var metalDetector : Sensor? = null

    var binding : ActivityHiddenCameraBinding? = null
    private var sensorManager: SensorManager? = null
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            binding = ActivityHiddenCameraBinding.inflate(layoutInflater)
            ...
            binding!!.backIcon.setOnClickListener {
                val intent = Intent(this@HiddenCamera, MainActivity::class.java)
        ...
        override fun onResume() {
            ...
            sensorManager!!.registerListener(
                ...
                Toast.makeText(this@HiddenCamera, "Not supported", Toast.LENGTH_SHORT).show()
                finish()
            }
        }
        ...
        override fun onSensorChanged(event: SensorEvent) {
            if (event.sensor == metalDetector) {
                ...
                binding!!.awesomeSpeedometer.speedTo(degree)
                if (degree >= 40) {
                    mpmetal!!.start()
             ...
             Toast.makeText(this@HiddenCamera,"No sensor detected", Toast.LENGTH_SHORT).show()
